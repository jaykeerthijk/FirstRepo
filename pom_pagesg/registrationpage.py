...
class RegistrationPage(Selenium_Wrapper):
    ...
    def registration_enter_first_name(self, fname):
        self.enter_text(RegistrationPage._txt_first_name, fname)

    def registration_enter_last_name(self, lname):
        self.enter_text(RegistrationPage._txt_last_name, lname)

    def registration_enter_email(self, email):
        self.enter_text(RegistrationPage._txt_email, email)

    def registration_enter_password(self, password):
        self.enter_text(RegistrationPage._txt_password, password)

    def registration_enter_confirm_password(self, password):
        self.enter_text(RegistrationPage._txt_confirm_password, password)
